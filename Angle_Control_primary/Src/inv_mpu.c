 ...
 * Hal_Delay_ms(unsigned long num_ms)
...
#define Hal_Delay_ms    Hal_Delay_ms
...
#define Hal_Delay_ms    msp430_Hal_Delay_ms
...
/* Hal_Delay_ms is a function already defined in ASF. */
