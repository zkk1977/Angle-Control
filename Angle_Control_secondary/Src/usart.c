...
void USER_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
	...
	{
		if(strstr((char *)Usart1_Message_Buff,"led_on"))	
      {
				LED_ON;
			}
			else if(strstr((char *)Usart1_Message_Buff,"led_off"))		
      {
			  LED_OFF;
			}
			memset((char *)Usart1_Message_Buff,'\0',	Usart.Usart1_Count);
  }
	...
	{
		if(strstr((char *)Usart2_Message_Buff,"led_on"))	
      {
				LED_ON;
			}
			else if(strstr((char *)Usart2_Message_Buff,"led_off"))		
      {
			  LED_OFF;
			}
			memset((char *)Usart2_Message_Buff,'\0',	Usart.Usart2_Count);
  }
